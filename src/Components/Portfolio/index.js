        ...
        <Container>
             <Row>
                <Col>  
                    ...
                    <Image src ={BudgetTrack} width="200" height="200" fluid />
                ...
                <Col>
                    ...
                    <Image src= {PizzaHunt} width="200" height="200" fluid />
                ...
                <Col>
                    ...
                    <Image src= {NoteTaker} width="200" height="200" fluid />
            ...
            <Row>
                <Col>
                    ...
                    <Image src= {ZooKeepr} width="200" height="200"fluid />
                ...
                <Col>
                    ...
                    <Image src= {PhotoPort} width="200" height="200" fluid />
                ...
                <Col>
                    ...
                    <Image src= {FoodFestival} width="200" height="200" fluid />
